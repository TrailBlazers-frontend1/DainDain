...
const FirstTwo = () => {
  ...
  const first2NumbersRow = (start,end) => {
    const arr = []
    for(let i = start; i <= end;i++){
      arr.push(
        
          <div className='first2-number-btn-container'>
            <p>{i <= 9 ? `0${i}` : i}</p>
  ...
  return (
    <div className='first2-parent-container'>
      <div className='first2-select-container'>
        <div className='first2-select-competiton-container'>
            <p className='first2-select-competiton-label'>
              Competition:
            </p>
            <button className='first2-select-competiton-btn'>Normal</button>
        </div>
      </div>

      <div className='twopieces-header-container'>
          <div className='twopieces-header-washrate'>
            <p className='twopieces-header'>First Two</p>
            <p className='twopieces-washrate'>wash rate   1.9</p>
          </div>
          <p className='twopieces-description'>Description</p>
      </div>

      <div className='first2-numbers-parent-container'>
        <p className='first2-numbers-label'>Choose Number</p>
        <div className='first2-number-btns-container'>
        {
          first2NumbersRow(0,9)
        }
        </div>
        <div className='first2-number-btns-container'>
        {
          first2NumbersRow(10,19)
        }
        </div>
        <div className='first2-number-btns-container'>
        {
          first2NumbersRow(20,29)
        }
        </div>
        <div className='first2-number-btns-container'>
        {
          first2NumbersRow(30,39)
        }
        </div>
        <div className='first2-number-btns-container'>
        {
          first2NumbersRow(40,49)
        }
        </div>
        <div className='first2-number-btns-container'>
        {
          first2NumbersRow(50,59)
        }
        </div>
        <div className='first2-number-btns-container'>
        {
          first2NumbersRow(60,69)
        }
        </div>
        <div className='first2-number-btns-container'>
        {
          first2NumbersRow(70,79)
        }
        </div>
        <div className='first2-number-btns-container'>
        {
          first2NumbersRow(80,89)
        }
        </div>
        <div className='first2-number-btns-container'>
        {
          first2NumbersRow(90,99)
        }
        </div>
